(function(define) {
	...
	define([], function() {
		...
		var UserManager = function(UserService,$http,i18nNotifications) {
			var deleteBtn='<a ng-click="grid.appScope.deleteConfirmation(row)" style="cursor:pointer;margin-left:2%" tooltip-placement="auto" tooltip="Delete" tooltip-append-to-body="true" data-toggle="modal" data-target="#deleteUserModel" ><i class="fa fa-trash-o fa-lg text-danger"></i></a>';
			...
			var data={
					...
					deleteUser:function(userGridData,obj){
		...
		return [ 'UserService','$http','i18nNotifications',UserManager  ];
	});
}(define));